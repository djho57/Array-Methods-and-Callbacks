...
function getFinals(array/* code here */) {
   /* code here */
   const qualifiers = fifaData.filter(function(item){
...
function getYears(array,getFinalscb/* code here */) {
    /* code here */
    const years = getFinalscb(array);
    const modYears = years.map((Year) => {
    return Year.Year;
    });
    return modYears;
}
...
function getWinners(array, getFinalscb/* code here */) {
...
function getWinnersByYear(array, getYearscb, getWinnerscb/* code here */) {
    /* code here */
...
function getAverageGoals(array/* code here */) {
   /* code here */
   const avgHome = array.reduce(function(acc,item){
       return acc + item['Home Team Goals'] + item['Away Team Goals'];
   }, 0)
   return (avgHome / array.length).toFixed(2);
}
